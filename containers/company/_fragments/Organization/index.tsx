      ...
      <Flex flexDir={'column'} pt={['30px', '50px', '60px']} px={['16px', '120px', '100px']} w={'100%'} maxW={['100%', '100%', 'calc(100% - 200px)']}>
        <Flex flexDir={'column'} align={'center'} justify={'center'}>
          ...
          {locale === 'ko' ? (
            ...
            <Box mt={'90px'}>
              {isMobile ? (
                <Image src={'/images/company/Eng_organization_mobile.svg'} alt={'organization image'} w={'100%'} h={'100%'} objectFit={'fill'} />
              ) : isTablet ? (
                <Image src={'/images/company/Eng_organization_tab.svg'} alt={'organization image'} w={'100%'} h={'100%'} />
              ) : (
                <Image src={'/images/company/Eng_organization_pc.svg'} alt={'organization image'} w={'100%'} h={'100%'} />
              )}
            </Box>
          )}
        </Flex>
